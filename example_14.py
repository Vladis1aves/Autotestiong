# Сохранение установленных модулей и пакетов в файле
# pip freeze > requirements.txt

# Как достать сохраненные пакеты
# pip install -r requirements.txt

#Можно разделить на основные пакеты и пакеты с зависимостями
#pip freeze >сonstraints.txt
